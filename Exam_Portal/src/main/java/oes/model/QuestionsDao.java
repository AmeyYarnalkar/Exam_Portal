...
public class QuestionsDao {
	...
	public static boolean insertQuestion(Questions q) {
		...
		String sql = "insert into Questions (question,option_a,option_b,option_c,option_d,answer) values(?,?,?,?,?,?)";
	...
	public static int doUpdateNowRecord(String OriginalQuestion,String newQuestion,String opta,String optb,String optc,String optd,String ans)
	{
		...
		Connection con = Provider.getOracleConnection();
		String sql = "update Questions set question=?,option_a=?,option_b=?,option_c=?,option_d=?,answer=? where question=?";
		PreparedStatement pst = con.prepareStatement(sql);
